...
var tabsBtn = document.querySelectorAll('.tabs_header__button_btn');
var tabsContent = document.querySelectorAll('.tabs_content');

var _loop = function _loop(index) {
  tabsBtn[index].addEventListener('click', function () {
    var tabsActiveBtn = document.querySelector('.tabs_header__button_btn.active');
    var tabsActiveContent = document.querySelector('.tabs_content.active');
...
//# sourceMappingURL=/burger.af4d02df.js.map